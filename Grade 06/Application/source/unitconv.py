...
st.set_page_config(page_title="My Webpage", page_icon="ds.png", layout='wide')
def unitconversion():
    def kilometer(num):
    ...
    with col3:
        num=st.number_input("",key="Clear3")
    with col2:
        st.write("")
        st.subheader("Select the Unit")
    with col3:
        select=st.selectbox("",("Select the unit","Kilometer","Hectometer","Decameter","Meter","Decimeter","Centimeter","Millimeter"),key="Clear")
    with col2:
        st.write("")
        st.subheader("Unit to convert")
    with col3:
        if select=="Kilometer":
            select2=st.selectbox("",("Select the unit","Hectometer","Decameter","Meter","Decimeter","Centimeter","Millimeter"),key="Clear2")
        elif select=="Hectometer":
            select2=st.selectbox("",("Select the unit","Kilometer","Decameter","Meter","Decimeter","Centimeter","Millimeter"),key="Clear2")
        elif select=="Decameter":
            select2=st.selectbox("",("Select the unit","Kilometer","Hectometer","Meter","Decimeter","Centimeter","Millimeter"),key="Clear2")
        elif select=="Meter":
            select2=st.selectbox("",("Select the unit","Kilometer","Hectometer","Decameter","Decimeter","Centimeter","Millimeter"),key="Clear2")
        elif select=="Decimeter":
            select2=st.selectbox("",("Select the unit","Kilometer","Hectometer","Decameter","Meter","Centimeter","Millimeter"),key="Clear2")
        elif select=="Centimeter":
            select2=st.selectbox("",("Select the unit","Kilometer","Hectometer","Decameter","Meter","Decimeter","Millimeter"),key="Clear2")
        else:
            select2=st.selectbox("",("Select the unit","Kilometer","Hectometer","Decameter","Meter","Decimeter","Centimeter"),key="Clear2")
    ...
    def cleartext():
        st.session_state["Clear"]="Select the unit"
        st.session_state["Clear2"]="Select the unit"
        st.session_state["Clear3"]=0
    ...
    if k:
        if select and select2=="Select the unit":
            with col3:
                st.subheader("Select a unit to convert")
